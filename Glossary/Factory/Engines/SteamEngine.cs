...
namespace Factory.Engines
{
    public class SteamEngine : IEngine
    {
        ...
        public void TurnOn() => Console.WriteLine("The fire under the steam vessel heats up the water and after quite some time the steam pressure is at a usable level.");
    }
}
